          ...
          <View className="w-full max-w-sm items-center">
            ...
            <View className="bg-slate-800 rounded-xl p-6 w-full gap-4">
              ...
              <View className="flex-row bg-gray-700 rounded-lg p-1">
                <TouchableOpacity
                  className={`flex-1 py-2 rounded-md ${authMethod === 'phone' ? 'bg-blue-600' : ''
                    }`}
                  onPress={() => {
                    setAuthMethod('phone');
                    setEmailErrors('');
                ...
                >
                  <Text
                    className={`text-center font-plus-jakarta-500 ${authMethod === 'phone' ? 'text-white' : 'text-gray-400'
                      }`}
                  >
                    Phone
                  </Text>
                ...
                <TouchableOpacity
                  className={`flex-1 py-2 rounded-md ${authMethod === 'email' ? 'bg-blue-600' : ''
                    }`}
                  onPress={() => {
                    setAuthMethod('email');
                    setPhoneErrors('');
                ...
                >
                  <Text
                    className={`text-center font-plus-jakarta-500 ${authMethod === 'email' ? 'text-white' : 'text-gray-400'
                      }`}
                  >
                    Email
                  </Text>
              ...
              {authMethod === 'phone' && (
                <View className="gap-2">
                  <Text className="text-white text-base font-plus-jakarta-500">
                    Phone Number
                  </Text>
                  <View className="flex-row gap-2 items-center">
                    <Text className="text-white text-base font-plus-jakarta">+1</Text>
                    <TextInput
                      className="flex-1 bg-gray-700 text-white rounded-lg px-4 py-3 font-plus-jakarta"
                  ...
                  {phoneErrors && (
                    <Text className="text-red-400 text-sm font-plus-jakarta">
                      {phoneErrors}
                    </Text>
                  )}
                  {phoneNumber.replace(/\D/g, '').length === 10 && (
                    <TouchableOpacity
                      className={`bg-blue-600 rounded-lg py-3 px-4 items-center justify-center ${isPhoneLoading ? 'opacity-60' : ''
                        }`}
              ...
              {authMethod === 'email' && (
                <View className="gap-2">
                  ...
                  {email.trim().length > 0 && (
                    <TouchableOpacity
                      className={`bg-blue-600 rounded-lg py-3 px-4 items-center justify-center ${isEmailLoading ? 'opacity-60' : ''
                        }`}
                ...
                >
                  {isGoogleLoading ? (
                    ...
                    <View className="flex flex-row items-center justify-between gap-2 w-full">
                      ...
                      <Text className="text-black text-xl font-plus-jakarta-600">
                ...
                >
                  {isGithubLoading ? (
                    ...
                    <View className="flex flex-row items-center justify-between gap-2 w-full">
                      ...
                      <Text className="text-white text-xl font-plus-jakarta-600">
              ...
              <Text className="text-gray-400 text-sm font-plus-jakarta-500 text-center italic">If you don't have an account, you can create one below</Text>
      ...
      <SafeScreen edges={['top', 'bottom']} className="bg-black">
        ...
        >
          <View className="w-full max-w-sm items-center">
            ...
            <Text className="text-white text-base font-plus-jakarta-500">All of your climbing data, in one place</Text>
            <Text className="text-3xl font-plus-jakarta-700 text-white mb-8 text-center">
              Create Account
            </Text>

            <View className="bg-slate-800 rounded-xl p-6 w-full gap-4">
              <TouchableOpacity onPress={handleBack} className="self-start mb-2">
                <Text className="text-gray-400 text-sm font-plus-jakarta">← Back</Text>
              </TouchableOpacity>
        ...
        >
          <View className="w-full max-w-sm items-center">
            ...
            <View className="bg-slate-800 rounded-xl p-6 w-full gap-4">
              ...
              <Text className="text-white text-base font-plus-jakarta mb-2">
                We sent a verification code to:
              </Text>

              <Text className="text-blue-400 text-base font-plus-jakarta mb-4">
                {displayValue}
              </Text>

              {authMethod === 'email' && <Text className="text-gray-400 text-sm italic font-plus-jakarta-500">If you do not receive a code through email, please check your spam folder.</Text>}

              <TextInput
                className="bg-gray-700 text-white rounded-lg px-4 py-3 font-plus-jakarta text-center text-2xl tracking-widest"
                placeholder="000000"
                placeholderTextColor="#9CA3AF"
              ...
              <TouchableOpacity
                className={`bg-blue-600 rounded-lg py-3 px-4 items-center justify-center ${isVerifying ? 'opacity-60' : ''
                  }`}
              ...
              <TouchableOpacity
                ...
                className="mt-2"
              >
                <Text className="text-blue-400 text-sm font-plus-jakarta text-center">
